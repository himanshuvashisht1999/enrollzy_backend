...
@push('css')
    ...
    <style>
        ...
        .existing-doc { font-size: 0.7rem; color: #4e73df; text-decoration: none; display: block; margin-top: 2px; }
    </style>
@endpush
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3 mb-4 align-items-start">
                                <div class="col-md-2 text-center">
                                    <div class="photo-preview-wrapper mx-auto mb-2" onclick="$('#student_photo').click()">
                                        @if($customer->image)
                                            <img id="photo_preview" src="{{ asset($customer->image) }}">
                                ...
                                <div class="col-md-10">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="alternate_mobile" class="form-control" value="{{ old('alternate_mobile', $customer->alternate_mobile) }}">
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="aadhaar_number" class="form-control" value="{{ old('aadhaar_number', $customer->aadhaar_number) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 mt-2">
                                    <div class="row g-3">
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" name="pincode" id="pincode" class="form-control" placeholder="6-digit" value="{{ old('pincode', $customer->pincode) }}">
                                        </div>
                                        <div class="col-md-5">
                                        ...
                                        {{-- <div class="col-md-4">
                                            ...
                                            <select name="institute_id" class="form-select select2">
                                                ...
                                                @foreach($institutes as $ins)
                                                    <option value="{{ $ins->id }}" {{ old('institute_id', $customer->institute_id) == $ins->id ? 'selected' : '' }}>{{ $ins->name }}</option>
                                                @endforeach
                                            </select>
                                        </div> --}}
                                    </div>
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-12"><input type="text" name="father_name" class="form-control form-control-sm" placeholder="Father Name" value="{{ old('father_name', $customer->father_name) }}"></div>
                                        <div class="col-md-6"><input type="text" name="father_mobile" class="form-control form-control-sm" placeholder="Mobile" value="{{ old('father_mobile', $customer->father_mobile) }}"></div>
                                        <div class="col-md-6"><input type="email" name="father_email" class="form-control form-control-sm" placeholder="Email" value="{{ old('father_email', $customer->father_email) }}"></div>
                                        <div class="col-12"><input type="text" name="father_occupation" class="form-control form-control-sm" placeholder="Occupation" value="{{ old('father_occupation', $customer->father_occupation) }}"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <h6 class="small fw-bold text-muted border-bottom pb-2 mb-3">Mother's Details</h6>
                                    <div class="row g-2">
                                        <div class="col-12"><input type="text" name="mother_name" class="form-control form-control-sm" placeholder="Mother Name" value="{{ old('mother_name', $customer->mother_name) }}"></div>
                                        <div class="col-md-6"><input type="text" name="mother_mobile" class="form-control form-control-sm" placeholder="Mobile" value="{{ old('mother_mobile', $customer->mother_mobile) }}"></div>
                                        <div class="col-md-6"><input type="email" name="mother_email" class="form-control form-control-sm" placeholder="Email" value="{{ old('mother_email', $customer->mother_email) }}"></div>
                                        <div class="col-12"><input type="text" name="mother_occupation" class="form-control form-control-sm" placeholder="Occupation" value="{{ old('mother_occupation', $customer->mother_occupation) }}"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive mb-4">
                                <table class="table table-bordered academic-table text-center">
                                    ...
                                    <tbody>
                                        @php $academicData = $customer->academic_details->keyBy('examination'); @endphp
                                        @foreach(['10th', '12th', 'Graduation', 'Post Graduation', 'Other'] as $exam)
                                            <tr>
                                                <td class="fw-bold small bg-light align-middle">{{ $exam }}</td>
                                                <td><input type="text" name="academics[{{ $exam }}][board]" class="form-control form-control-sm border-0" value="{{ old('academics.'.$exam.'.board', $academicData[$exam]->board_university ?? '') }}"></td>
                                                <td><input type="text" name="academics[{{ $exam }}][college]" class="form-control form-control-sm border-0" value="{{ old('academics.'.$exam.'.college', $academicData[$exam]->school_college ?? '') }}"></td>
                                                <td><input type="text" name="academics[{{ $exam }}][year]" class="form-control form-control-sm border-0" value="{{ old('academics.'.$exam.'.year', $academicData[$exam]->year ?? '') }}"></td>
                                                <td><input type="text" name="academics[{{ $exam }}][percentage]" class="form-control form-control-sm border-0" value="{{ old('academics.'.$exam.'.percentage', $academicData[$exam]->percentage ?? '') }}"></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                            ...
                                            <div class="col-md-6">
                                                <div class="doc-upload-item d-flex align-items-center justify-content-between">
                                                    <div>
                                                        ...
                                                        @if(isset($documentData[$doc]))
                                                            <a href="{{ asset($documentData[$doc]->file_path) }}" target="_blank" class="existing-doc"><i class="fas fa-eye me-1"></i>View Existing</a>
                                                        @endif
                                                    </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="card bg-light border-0 p-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="referred_by" class="form-control" value="{{ old('referred_by', $customer->referred_by) }}">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label class="form-label d-block">Sibling Enrolled?</label>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="sibling_enrolled" id="s_yes" value="1" {{ old('sibling_enrolled', $customer->sibling_enrolled) == '1' ? 'checked' : '' }}>
                                                    <label class="form-check-label small" for="s_yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="sibling_enrolled" id="s_no" value="0" {{ old('sibling_enrolled', $customer->sibling_enrolled) == '0' ? 'checked' : '' }}>
                                                    <label class="form-check-label small" for="s_no">No</label>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mt-2" id="sibling_details_container" style="{{ old('sibling_enrolled', $customer->sibling_enrolled) == '1' ? '' : 'display:none;' }}">
                                                <div class="row g-2">
                                                    <div class="col-md-6">
                                                        <label class="form-label small">Sibling Name</label>
                                                        <input type="text" name="sibling_name" class="form-control form-control-sm" value="{{ old('sibling_name', $customer->sibling_name) }}" placeholder="Name">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label small">Sibling Age</label>
                                                        <input type="number" name="sibling_age" class="form-control form-control-sm" value="{{ old('sibling_age', $customer->sibling_age) }}" placeholder="Age">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                            ...
                            <div class="row g-3 p-3 bg-light rounded-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="registration_no" class="form-control" placeholder="INTERNAL-ID" value="{{ old('registration_no', $customer->registration_no) }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Reg. Date</label>
                                    <input type="date" name="registration_date" class="form-control" value="{{ old('registration_date', $customer->registration_date ?? date('Y-m-d')) }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Counselor</label>
                                    <input type="text" name="counselor_name" class="form-control" value="{{ old('counselor_name', $customer->counselor_name) }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Class / Batch</label>
                                    <input type="text" name="class_batch" class="form-control" placeholder="e.g. Evening Batch" value="{{ old('class_batch', $customer->class_batch) }}">
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select name="payment_status" class="form-select">
                                        ...
                                        <option value="Partial" {{ old('payment_status', $customer->payment_status) == 'Partial' ? 'selected' : '' }}>Partial</option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="remarks" class="form-control" rows="2" placeholder="Any special notes...">{{ old('remarks', $customer->remarks) }}</textarea>
                                </div>
                            </div>

                        </div>
                        <div class="card-footer bg-white p-4 text-center border-0">
                            <button type="submit" class="btn btn-primary px-5 py-2 fw-bold rounded-pill">UPDATE STUDENT RECORD</button>
                            <a href="{{ route('admin.customers.main.index.index') }}" class="btn btn-link text-muted ms-3">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
