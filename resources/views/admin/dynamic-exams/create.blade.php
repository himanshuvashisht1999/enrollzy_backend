                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="result_status" class="form-control"
                                    placeholder="e.g. Declared / TBA" value="{{ old('result_status') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Registration</label>
                                <input type="text" name="registration_status" class="form-control"
                                    placeholder="e.g. Open" value="{{ old('registration_status') }}">
                            </div>
                            <div class="col-md-3">
