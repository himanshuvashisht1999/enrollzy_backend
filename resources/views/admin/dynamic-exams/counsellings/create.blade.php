...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Add New Counselling for {{ $dynamicExam->name }}</h4>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form id="counselling-form" action="{{ route('admin.dynamic-exams.counsellings.store', $dynamicExam->id) }}"
                method="POST">
                @csrf
                <div class="card">
                    <div class="card-body">
            ...
            function saveStepData() {
                ...
                if (!counsellingId && currentTabId === 'basic_info') {
                    ...
                    const formData = {
                        ...
                        conducting_authority_name: $('input[name="conducting_authority_name"]').val(),
                        _token: '{{ csrf_token() }}'
                    };

                    if (!formData.counselling_name || !formData.conducting_authority_name) return;

                    isSaving = true;
                    showAutoSaveStatus('saving');
                    $.ajax({
                        url: '{{ route("admin.dynamic-exams.counsellings.store-draft", $dynamicExam->id) }}',
                        method: 'POST',
                        data: formData,
                        success: function (response) {
                            ...
                            const updateUrl = `/admin/dynamic-exams/{{ $dynamicExam->id }}/counsellings/${counsellingId}`;
