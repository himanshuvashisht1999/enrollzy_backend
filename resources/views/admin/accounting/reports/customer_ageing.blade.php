...
@section('title', 'Customer Receivables Ageing')
...
<div class="container-fluid px-4 py-3">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <h3 class="fw-bold mb-1"><i class="fas fa-user-clock text-danger me-2"></i>Customer Receivables Ageing Report</h3>
            <p class="text-muted small mb-0">Ageing Analysis of Outstanding Customer Balances as of {{ \Carbon\Carbon::parse($asOfDate)->format('d F Y') }}</p>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-3 mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.accounting.reports.customer_ageing') }}" class="row g-3 align-items-end">
                <div class="col-md-6">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted py-4">No outstanding receivables found as of this date.</td>
                            </tr>
                        @endforelse
                    </tbody>
