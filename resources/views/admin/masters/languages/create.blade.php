...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-0 fw-bold">Add Language</h4>
        <p class="text-muted mb-0">Create a new course language entry.</p>
    </div>
            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.languages.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="e.g. Hindi, English" required>
                    </div>
