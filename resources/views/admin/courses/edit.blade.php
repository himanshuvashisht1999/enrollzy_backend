                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="e.g. M.Des (Communication Design)"
                                   required>
                            @error('name')
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="course_overview" name="overview" class="form-control editor">{{ old('overview', $course->overview) }}</textarea>
                        </div>

                        {{-- Generic Eligibility --}}
                        <div class="col-12">
                            <label class="form-label fw-bold">Generic Eligibility</label>
                            <textarea id="course_generic_eligibility" name="generic_eligibility" class="form-control editor">{{ old('generic_eligibility', $course->generic_eligibility) }}</textarea>
                        </div>

                        {{-- Core Curriculum --}}
                        <div class="col-12">
                            <label class="form-label fw-bold">Core Curriculum / Subjects</label>
                            <textarea id="course_core_curriculum" name="core_curriculum" class="form-control editor">{{ old('core_curriculum', $course->core_curriculum) }}</textarea>
                        </div>

                        {{-- Skills Gained --}}
                        <div class="col-12">
                            <label class="form-label fw-bold">Skills Gained</label>
                            <textarea id="course_skills_gained" name="skills_gained" class="form-control editor">{{ old('skills_gained', $course->skills_gained) }}</textarea>
                        </div>

                        {{-- Career Scope --}}
                        <div class="col-12">
                            <label class="form-label fw-bold">Career Scope & Job Roles</label>
                            <textarea id="course_career_scope" name="career_scope" class="form-control editor">{{ old('career_scope', $course->career_scope) }}</textarea>
                        </div>

                        {{-- Higher Education Options --}}
                        <div class="col-12">
                            <label class="form-label fw-bold">Higher Education Options</label>
                            <textarea id="course_higher_education_options" name="higher_education_options" class="form-control editor">{{ old('higher_education_options', $course->higher_education_options) }}</textarea>
                        </div>

                        {{-- Course Comparison --}}
                        <div class="col-12">
                            <label class="form-label fw-bold">Course Comparison</label>
                            <textarea id="course_course_comparison" name="course_comparison" class="form-control editor">{{ old('course_comparison', $course->course_comparison) }}</textarea>
                        </div>

                        {{-- Pros & Cons --}}
                        <div class="col-12">
                            <label class="form-label fw-bold">Pros & Cons / Who Should Take This</label>
                            <textarea id="course_pros_cons" name="pros_cons" class="form-control editor">{{ old('pros_cons', $course->pros_cons) }}</textarea>
                        </div>
                    ...
                    if (res.status === 'success' && res.data) {
                        ...
                        if (typeof Swal !== 'undefined') {
                            Swal.fire({
                                ...
                                text: 'All fields have been filled using Google Gemini AI. Please review and click Update Course to save.',
                                timer: 3500,
