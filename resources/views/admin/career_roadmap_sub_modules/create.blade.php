                    ...
                    <div class="row bg-light p-3 rounded mb-4 border">
                        <div class="col-md-6 border-end">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="btn1_label" value="{{ old('btn1_label', 'Get Guidance') }}" placeholder="e.g. Get Guidance (Leave empty to hide button)">
                            </div>
                            <div class="mb-2">
                                <label class="form-label small fw-bold">Button URL</label>
                                <input type="text" class="form-control" name="btn1_url" value="{{ old('btn1_url', '/contact-us') }}" placeholder="e.g. /contact-us or https://...">
                            </div>
                        </div>
                        <div class="col-md-6 ps-md-4">
                            ...
                            <div class="mb-3">
                                <label class="form-label small fw-bold">Button Label (Text)</label>
                                <input type="text" class="form-control" name="btn2_label" value="{{ old('btn2_label', 'Talk to Counselor') }}" placeholder="e.g. Talk to Counselor (Leave empty to hide button)">
                            </div>
                            <div class="mb-2">
                                <label class="form-label small fw-bold">Button URL</label>
                                <input type="text" class="form-control" name="btn2_url" value="{{ old('btn2_url', '/contact-us') }}" placeholder="e.g. /contact-us or https://...">
                            </div>
                        </div>
                    </div>
