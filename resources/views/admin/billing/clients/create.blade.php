...
@section('title', 'Add New Billing Client')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1 text-dark fw-bold">Add New Billing Client</h4>
        <p class="text-muted small mb-0">Create a new client profile for billing, invoicing, and tax tracking.</p>
    </div>
...
<form action="{{ route('admin.billing.clients.store') }}" method="POST">
    @csrf
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-7">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Acme Tech Solutions Pvt Ltd" required>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="gstin" class="form-control text-uppercase @error('gstin') is-invalid @enderror" value="{{ old('gstin') }}" placeholder="e.g. 07AAAAA0000A1Z5" maxlength="25">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="tan_number" class="form-control text-uppercase @error('tan_number') is-invalid @enderror" value="{{ old('tan_number') }}" placeholder="e.g. DELA12345E" maxlength="25">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="pan_number" class="form-control text-uppercase @error('pan_number') is-invalid @enderror" value="{{ old('pan_number') }}" placeholder="e.g. ABCDE1234F" maxlength="25">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="cin_number" class="form-control text-uppercase @error('cin_number') is-invalid @enderror" value="{{ old('cin_number') }}" placeholder="e.g. U72900DL2020PTC123456" maxlength="50">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="contact_person" class="form-control @error('contact_person') is-invalid @enderror" value="{{ old('contact_person') }}" placeholder="e.g. John Doe">
                            @error('contact_person') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Email Address</label>
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="e.g. billing@acme.com">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <textarea name="address" rows="3" class="form-control @error('address') is-invalid @enderror" placeholder="Full street address, suite / unit / floor...">{{ old('address') }}</textarea>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="state" class="form-control @error('state') is-invalid @enderror" value="{{ old('state') }}" placeholder="e.g. Delhi">
                            @error('state') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Pincode / Postal Code</label>
                            <input type="text" name="pincode" class="form-control @error('pincode') is-invalid @enderror" value="{{ old('pincode') }}" placeholder="e.g. 110001">
                            @error('pincode') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Country</label>
                            <input type="text" name="country" class="form-control @error('country') is-invalid @enderror" value="{{ old('country', 'India') }}" placeholder="e.g. India">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="notes" rows="4" class="form-control @error('notes') is-invalid @enderror" placeholder="Optional notes for internal billing reference...">{{ old('notes') }}</textarea>
                        @error('notes') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                </div>
                <div class="card-footer bg-white border-top py-3">
                    <button type="submit" class="btn btn-primary w-100 py-2 fw-semibold">
                        <i class="fas fa-save me-1"></i> Save Billing Client
                    </button>
                </div>
            </div>
        </div>
