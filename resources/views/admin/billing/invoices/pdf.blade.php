...
<body>
    ...
    <div class="card">
        ...
        <table class="header-table">
            <tr>
                ...
                <td style="padding-right: 10px;">
                    <div class="company-name">{{ $setting->site_name ?? 'Uniband 8 Education Technology Private Limited' }}</div>
                    <div class="text-muted" style="line-height: 1.3;">
                        ...
                        @if($setting && $setting->contact_email)
                            <strong class="text-dark">Email:</strong> {{ $setting->contact_email }}<br>
                        @endif
                        @if($setting && $setting->gst_number)
                            <strong class="text-dark">GSTIN:</strong> {{ $setting->gst_number }}
                        @endif
                    </div>
                </td>
        ...
        <div style="margin-top: 15px; font-size: 10px; color: #6c757d;">
            Generated by <strong class="text-dark">{{ $setting->site_name ?? 'Uniband 8 Education Technology Private Limited' }}</strong> on {{ now()->format('d M Y, H:i') }}.
        </div>
    </div>
