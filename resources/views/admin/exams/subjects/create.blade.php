...
@section('title', 'Add New Exam Subject')

@section('content')
    <div class="container-fluid p-0">
        <form action="{{ route('admin.exam-subjects.store') }}" method="POST" id="subject-form">
            @csrf

            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-0 fw-bold">Add New Exam Subject</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item small"><a href="{{ route('admin.exams.index') }}">Exams List</a></li>
                            <li class="breadcrumb-item small"><a
                                    href="{{ route('admin.exam-subjects.index', request()->only(['exam_id', 'exam_stage_id'])) }}">Subjects
                                    List</a></li>
                            <li class="breadcrumb-item small active" aria-current="page">Add New</li>
                        </ol>
                    </nav>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.exam-subjects.index', request()->only(['exam_id', 'exam_stage_id'])) }}"
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <select name="exam_id" class="form-select select2" required>
                                        ...
                                        @foreach($exams as $exam)
                                            <option value="{{ $exam->id }}" {{ (old('exam_id', request()->exam_id) == $exam->id || ($selectedExam && $selectedExam->id == $exam->id)) ? 'selected' : '' }}>
                                                {{ $exam->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="exam_stage_id" class="form-select select2" required>
                                        ...
                                        @foreach($stages as $stage)
                                            <option value="{{ $stage->id }}" {{ (old('exam_stage_id', request()->exam_stage_id) == $stage->id || ($selectedStage && $selectedStage->id == $stage->id)) ? 'selected' : '' }}>
                                                {{ $stage->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="subject_group" class="form-control"
                                        value="{{ old('subject_group') }}" placeholder="e.g. Paper I, Group A">
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="tab-pane fade" id="selection" role="tabpanel">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="subject_combination_rules" class="form-control" rows="3"
                                        placeholder="Define rules for allowed combinations..."></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="syllabus" role="tabpanel">
                            ...
                            <div class="row g-4">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="syllabus_description" class="form-control editor" rows="4"></textarea>
                                </div>
                                <div class="col-md-8">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="reference_books[]" class="form-select select2" multiple data-tags="true"
                                        data-placeholder="Add book names and press enter">
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="marking" role="tabpanel">
                            ...
                            <div class="row g-4">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="number_of_papers" class="form-control" value="1">
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <select name="paper_names[]" class="form-select select2" multiple data-tags="true"
                                        data-placeholder="e.g. Paper I, Paper II">
                                    </select>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-switch mt-4">
                                        <input class="form-check-input" type="checkbox" name="negative_marking"
                                            id="neg_marking" value="1" checked>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label fw-bold small" for="bg_sub">Background Subject
                                            Required (at Degree Level)?</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="subject_result_type" class="form-select select2">
                                        <option value="Marks">Numerical Marks</option>
                            ...
                            <div class="row g-4">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="meta_title" class="form-control"
                                        placeholder="SEO Title for Subject Page">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label small fw-bold">Meta Description</label>
                                    <textarea name="meta_description" class="form-control" rows="3"
                                        placeholder="Brief SEO description..."></textarea>
                                </div>
                                <div class="col-md-12">
    ...
    <script>
        $(document).ready(function () {
            ...
            function addUnit() {
                ...
                if (unitIndex === 1) {
                    // Smooth scroll to first unit if needed
                }
            }
