                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white border-bottom-0">
                        <ul class="nav nav-tabs card-header-tabs" id="expertTabs" role="tablist">
                            <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#ex-basic">1.
                                    Identity</a></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#ex-credentials">2.
                                    Credentials</a></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#ex-institute">3.
                                    Institute</a></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#ex-teaching">4.
                                    Teaching</a></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#ex-performance">5.
                                    Performance</a></li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#ex-content">6. Content</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#ex-ratings">7. Ratings</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#ex-contact">8. Contact &
                                    SEO</a></li>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control" name="email"
                                            value="{{ old('email', $expert->email) }}" required>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <select name="expert_category_id" class="form-select" required>
                                            ...
                                            @foreach(\App\Models\ExpertCategory::where('is_active', true)->get() as $cat)
                                                <option value="{{ $cat->id }}" {{ (old('expert_category_id') ?? $expert->expert_category_id) == $cat->id ? 'selected' : '' }}>{{ $cat->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="gender" class="form-select">
                                            ...
                                            @foreach(['Male', 'Female', 'Other'] as $gender)
                                                <option value="{{ $gender }}" {{ $expert->gender == $gender ? 'selected' : '' }}>
                                                    {{ $gender }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="price_per_min"
                                            value="{{ old('price_per_min', $expert->price_per_min ?? 10.00) }}"
                                            placeholder="e.g. 10.00">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label fw-bold">Featured on Homepage <span
                                                class="text-danger">*</span></label>
                                        <select name="is_featured" class="form-select">
                                            <option value="0" {{ old('is_featured', $expert->is_featured ?? 0) == 0 ? 'selected' : '' }}>No</option>
                                            <option value="1" {{ old('is_featured', $expert->is_featured ?? 0) == 1 ? 'selected' : '' }}>Yes</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Date of Birth</label>
                                        <input type="text" class="form-control" name="date_of_birth"
                                            value="{{ old('date_of_birth', $expert->date_of_birth?->format('Y-m-d')) }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        @if($expert->img)
                                            <div class="mb-2">
                                                <br><img
                                                    src="{{ str_starts_with($expert->img, 'http') ? $expert->img : asset($expert->img) }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="short_bio" rows="2"
                                            maxlength="255">{{ old('short_bio', $expert->short_bio) }}</textarea>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Detailed Bio</label>
                                        <textarea class="form-control" name="detailed_bio"
                                            rows="4">{{ old('detailed_bio', $expert->detailed_bio) }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="highest_qualification"
                                            value="{{ $expert->highest_qualification }}">
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" step="0.1" class="form-control"
                                            name="years_of_experience_total"
                                            value="{{ $expert->years_of_experience_total }}">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Current Inst. Exp</label>
                                        <input type="number" step="0.1" class="form-control"
                                            name="years_of_experience_current_institute"
                                            value="{{ $expert->years_of_experience_current_institute }}">
                                    </div>
                                    <div class="col-md-12">
                                            ...
                                            @if($expert->other_qualifications && is_array($expert->other_qualifications))
                                                @foreach($expert->other_qualifications as $index => $qual)
                                                    ...
                                                    <div class="row g-2 mb-2 qualification-row align-items-end">
                                                        <div class="col-md-4">
                                                            <input type="text" name="other_qualifications[{{ $index }}][name]"
                                                                class="form-control form-control-sm" value="{{ $name }}"
                                                                placeholder="Degree">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input type="text" name="other_qualifications[{{ $index }}][institute]"
                                                                class="form-control form-control-sm" value="{{ $institute }}"
                                                                placeholder="Institute">
                                                        </div>
                                                        <div class="col-md-2">
                                                            <input type="number" name="other_qualifications[{{ $index }}][year]"
                                                                class="form-control form-control-sm" value="{{ $year }}"
                                                                placeholder="Year">
                                                        </div>
                                                        <div class="col-md-2">
                                                            <button type="button"
                                                                class="btn btn-sm btn-danger remove-qualification-btn"><i
                                        ...
                                        <template id="qualification-row-template">
                                            <div class="row g-2 mb-2 qualification-row align-items-end">
                                                <div class="col-md-4">
                                                    <input type="text" name="other_qualifications[INDEX][name]"
                                                        class="form-control form-control-sm" placeholder="Degree">
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="text" name="other_qualifications[INDEX][institute]"
                                                        class="form-control form-control-sm" placeholder="Institute">
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="number" name="other_qualifications[INDEX][year]"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch mt-2">
                                            <input class="form-check-input" type="checkbox" name="industry_experience"
                                                value="1" {{ $expert->industry_experience ? 'checked' : '' }}>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="current_institute_name"
                                            value="{{ $expert->current_institute_name }}">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select name="faculty_type" class="form-select">
                                            @foreach(['Full-time', 'Part-time', 'Visiting'] as $ft)
                                                <option value="{{ $ft }}" {{ $expert->faculty_type == $ft ? 'selected' : '' }}>
                                                    {{ $ft }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control" name="joining_year"
                                            value="{{ $expert->joining_year }}">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="average_batch_size_handled"
                                            value="{{ $expert->average_batch_size_handled }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="weekly_classes_count"
                                            value="{{ $expert->weekly_classes_count }}">
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check form-switch p-2 border rounded">
                                            <input class="form-check-input" type="checkbox" name="doubt_solving_sessions"
                                                value="1" {{ $expert->doubt_solving_sessions ? 'checked' : '' }}>
                                            <label class="form-check-label px-2">Doubt Solving Sessions</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check form-switch p-2 border rounded">
                                            <input class="form-check-input" type="checkbox" name="one_to_one_mentoring"
                                                value="1" {{ $expert->one_to_one_mentoring ? 'checked' : '' }}>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control" name="students_selected_count"
                                            value="{{ $expert->students_selected_count }}">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Best Result Year</label>
                                        <input type="number" class="form-control" name="best_result_year"
                                            value="{{ $expert->best_result_year }}">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Verification Source</label>
                                        <input type="text" class="form-control" name="result_verification_source"
                                            value="{{ $expert->result_verification_source }}">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Top Rank Students (JSON)</label>
                                        <textarea class="form-control" name="top_rank_students"
                                            rows="3">{{ is_array($expert->top_rank_students) ? json_encode($expert->top_rank_students) : $expert->top_rank_students }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="total_reviews"
                                            value="{{ $expert->total_reviews }}">
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox"
                                                name="verified_student_reviews_only" value="1" {{ $expert->verified_student_reviews_only ? 'checked' : '' }}>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-switch mt-4">
                                            <input class="form-check-input" type="checkbox" name="public_contact_allowed"
                                                value="1" {{ $expert->public_contact_allowed ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check form-switch mt-4">
                                            <input class="form-check-input" type="checkbox" name="profile_claimed" value="1"
                                                {{ $expert->profile_claimed ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="canonical_url"
                                            value="{{ $expert->canonical_url }}">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Meta Description</label>
                                        <textarea class="form-control" name="meta_description"
                                            rows="2">{{ $expert->meta_description }}</textarea>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="status" class="form-select">
                                            @foreach(['Active', 'Inactive', 'Archived'] as $s)
                                                <option value="{{ $s }}" {{ $expert->status == $s ? 'selected' : '' }}>{{ $s }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-info border-0 shadow-sm">
                                        <h6 class="alert-heading fw-bold"><i class="fas fa-info-circle me-2"></i> How
                                            Commission Works</h6>
                                        <p class="mb-0 small">
                                            The system resolves commission in this order: <br>
                                            <strong>Booking Override > Expert Specific > Category Specific > Global
                                                Default</strong>.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card bg-light border-0 mb-3">
                                        <div class="card-body">
                                            <h6 class="text-uppercase text-muted small fw-bold">Current Expert Configuration
                                            </h6>
                                            @if($activeCommission)
                                                ...
                                                <p class="small text-muted mb-0">Reason:
                                                    {{ $activeCommission->reason ?? 'N/A' }}</p>
                                                <p class="small text-muted">Created:
                                                    {{ $activeCommission->created_at->format('d M, Y') }}</p>
                                            @else
                ...
                <form action="{{ route('experts.commission.update', $expert->id) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <p class="small text-muted mb-3">
                            Define a specific commission rule for this expert. This will <strong>override</strong> Global
