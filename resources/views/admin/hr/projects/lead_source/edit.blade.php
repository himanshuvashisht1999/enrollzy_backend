            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-white py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="m-0 fw-bold">Edit Lead Source</h5>
                    </div>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.hr.projects.lead-sources.update', encrypt($leadSource->id)) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control border-start-0 rounded-end-pill @error('name') is-invalid @enderror" placeholder="e.g. Google Ads, Referral" required value="{{ old('name', $leadSource->name) }}">
                            </div>
                            @error('name')
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-2">
                            ...
                            <button type="submit" class="btn btn-warning rounded-pill px-5 fw-bold shadow-sm">
                                Update Source <i class="fas fa-save ms-1 small"></i>
                            </button>
                        </div>
                    </form>
                </div>
