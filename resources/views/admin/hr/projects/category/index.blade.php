...
<div class="container-fluid">
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 fw-bold text-primary">Managed Project Categories</h6>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            <div class="modal-header border-0 pb-0">
                <h5 class="fw-bold">New Category</h5>
            ...
            <form action="{{ route('admin.hr.projects.project-categories.store') }}" method="POST">
                ...
                <div class="modal-body pb-0">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control rounded-3" placeholder="e.g. Web Development, Marketing" required>
                    </div>
                    <div class="mb-3">
...
<script>
    $(document).ready(function() {
        $('#categoryTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.hr.projects.project-categories.index') }}",
            columns: [
