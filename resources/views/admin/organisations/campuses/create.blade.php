                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="exams_prepared_for[]" class="form-select select2 entrance-exam-ids-select" multiple>
                                            @foreach($exams as $exam)
                                                <option value="{{ $exam->name }}" data-category="{{ is_array($exam->exam_category) ? implode(',', $exam->exam_category) : ($exam->exam_category ?? '') }}" {{ in_array($exam->name, old('exams_prepared_for', [])) ? 'selected' : '' }}>
                                                    {{ $exam->name }}
                                                </option>
                                            @endforeach
                                        </select>
