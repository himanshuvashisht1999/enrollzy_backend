...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <form id="updateLeaveTypeForm" method="POST" action="{{ route('admin.banks.update', encrypt($banks->id)) }}">
                <div class="card-header py-3 d-flex justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary"> Edit Bank Detail </h6>
                </div>
                <div class="card-body row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{ old('name', $banks->name) }}"
                            required>
                    </div>
                            <div class="col-md-3 form-group mb-4">
                                ...
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option {{ old('status', $banks->status) == 'active' ? 'selected' : '' }} value="active">
                                        Active</option>
                                    <option {{ old('status', $banks->status) == 'inactive' ? 'selected' : '' }}
