    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between">
                ...
                <div class="card-body">
                    <form id="addWhatsappTemplateForm" action="{{ route('admin.whatsapp_template.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea name="message" class="form-control"  id="message-editor"  placeholder="Enter message">{{ old('message') }}</textarea>
                            </div>
                        </div>
                    </form>
                </div>
