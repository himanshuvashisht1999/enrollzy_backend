...
<head>
    ...
    <title>Amit Book Depot | Staff Reset Password </title>
                ...
                <td>
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <h3 style="font-weight: 700; font-size: 20px; margin: 0;">Staff Password Reset
                                    </h3>
                                </td>
                                <td>
                                    <p
                                        style="font-size: 17px;font-weight: 600;width: 74%;margin: 8px auto 0;line-height: 1.5;color: #939393;">
                                        We received a request to reset your account password. If you made this request,
                    ...
                    <table class="button-table" style="margin-top: 27px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <a href="https://amitbookdepot.com/password_reset/{{ $token }}"
                                        class="password-button"> Reset
                                        Password</a>
                                </td>
                            </tr>
                        </thead>
                            ...
                            <tr style="display: block;">
                                <td>
                                    <p
                                        ...
                                        support. Do not share this link with anyone for security reasons.
