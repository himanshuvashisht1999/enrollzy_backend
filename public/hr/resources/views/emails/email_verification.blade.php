...
<head>
   ...
   <title>Amit Book Depot | User Email Verification </title>
            ...
            <td>
               <table class="header-table" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr class="header"
                     ...
                     <td class="header-logo" style="padding: 10px 32px;">
                        <a href="https://www.amitbookdepot.com/" style="display: block; text-align: left;">
                           <img
                              src="https://www.amitbookdepot.com/public/uploads/logo/cJYFGlvjmufXdKGAFaVwvSg86NPKGoPlSl5u69eK.png"
                  ...
                  <thead>
                     <tr style="display: block;">
                        <td style="display: block;">
                           <h3 style="font-weight: 700; font-size: 20px; margin: 0;">User Email Verification</h3>
                        </td>
                        <td>
                           <p
                              style="font-size: 17px;font-weight: 600;width: 74%;margin: 8px auto 0;line-height: 1.5;color: #939393;">
                              We’re Sending you this email because your email is not verified. Please share this OTP to
                              your Admin so We can verify the Email:</p>
                        </td>
                     </tr>
                  </thead>
               </table>
               ...
               <table class="button-table" style="margin-top: 27px;" align="center" border="0" cellpadding="0"
                  ...
                  <thead>
                     <tr style="display: block;">
                        <td style="display: block;">
                           <button class="password-button">{{ $data['token'] }}</button>
                        </td>
                     </tr>
                  </thead>
               </table>
                  ...
                  <thead>
                     <tr style="display: block;">
                        <td style="display: block;">
                           <p
                              style="font-size: 17px;font-weight: 600;width: 74%;margin: 8px auto 0;line-height: 1.5;color: #939393;">
                              If you didn’t want to verify, you can ignore this email. Your email will not be update.
                           </p>
                        </td>
                     </tr>
                  </thead>
                           ...
                           <tr>
                              <td>
                                 <h4 style="font-size: 19px; font-weight: 700; margin: 0;">Shop For <span
                                       class="theme-color">Amit Book Depot</span></h4>
                              </td>
                           </tr>
                        </table>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                           <tr>
                              <td>
                                ...
                                letter-spacing:1px; font-weight: 500;">
                                    2024-25 copy right by Amit Book Depot</h5>
                              </td>
                           </tr>
                        </table>
                     </td>
