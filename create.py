with open('resources/views/admin/filtered-pages/create.blade.php', 'w') as f:
    f.write('''@extends('admin.layouts.master')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="ownership_type" class="form-control">
                            ...
                            <option value="Public" {{ $filteredPage->ownership_type == 'Public' ? 'selected' : '' }}>Public</option>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="school_type_id" class="form-control">
                            <option value="">Select School Type</option>
                            @foreach($schoolTypes as $type)
                                <option value="{{ $type->id }}" {{ $filteredPage->school_type_id == $type->id ? 'selected' : '' }}>{{ $type->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4 mb-3">
